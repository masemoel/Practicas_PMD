package com.masemoel.dinosaurio.game.entities;
...
public class EntityFactory {
    ...
    public CactusEntity createSpikes(World world, float x, float y) {
        Texture spikeTexture = manager.get("spike.png");
        return new CactusEntity(world, spikeTexture, x, y);
    }
}